"use strict";
// Firebase configuration for Electron main process
// This file is separate from the renderer config because Electron main process
// doesn't have access to Vite's import.meta.env
